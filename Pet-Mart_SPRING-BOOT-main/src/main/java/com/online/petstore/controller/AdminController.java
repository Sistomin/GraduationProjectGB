...
public class AdminController {
   ...
   public String saveAccount(Model model,
	   ...
	   if (result.hasErrors()) {
           return "signup"; // Возврат страницы регистрации с ошибками проверки
       }
       ...
       try {
           ...
           return "signup"; // Возврат страницы регистрации с сообщением об ошибке
       }
